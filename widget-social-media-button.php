...
class Widget_Social_Media_Button extends WP_Widget {
	...
	public function __construct() {
		parent::__construct( 'sm_buttons_widget', __( 'Social Media Buttons', 'smbuttons' ),
        ...
        <div class="smb-<?php echo $widget_id; ?>">
			...
			<?php if ( ! empty( $gp_url ) ): ?>
                <a title="Google+" target="_blank" href="<?php echo esc_url( $gp_url ); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 36 28">
                        <path d="M22.5 14.3c0 6.5-4.4 11.2-11 11.2-6.3 0-11.5-5.1-11.5-11.5s5.1-11.5 11.5-11.5c3.1 0 5.7 1.1 7.7 3l-3.1 3c-0.8-0.8-2.3-1.8-4.6-1.8-3.9 0-7.1 3.2-7.1 7.2s3.2 7.2 7.1 7.2c4.5 0 6.2-3.3 6.5-4.9h-6.5v-3.9h10.8c0.1 0.6 0.2 1.2 0.2 1.9zM36 12.4v3.3h-3.3v3.3h-3.3v-3.3h-3.3v-3.3h3.3v-3.3h3.3v3.3h3.3z"/>
                    </svg>
                </a>
			<?php endif; ?>
			...
			<?php if ( ! empty( $digg ) ): ?>
                <a title="Digg" target="_blank" href="<?php echo esc_url( $digg ); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 28">
                        <path d="M5.1 4.4h3.2v15.4h-8.3v-10.9h5.1v-4.5zM5.1 17.2v-5.8h-1.9v5.8h1.9zM9.6 8.9v10.9h3.2v-10.9h-3.2zM9.6 4.4v3.2h3.2v-3.2h-3.2zM14.1 8.9h8.3v14.7h-8.3v-2.5h5.1v-1.3h-5.1v-10.9zM19.2 17.2v-5.8h-1.9v5.8h1.9zM23.7 8.9h8.3v14.7h-8.3v-2.5h5.1v-1.3h-5.1v-10.9zM28.8 17.2v-5.8h-1.9v5.8h1.9z"></path>
                    </svg>
                </a>
			<?php endif; ?>
			...
			<?php if ( ! empty( $dropbox ) ): ?>
                <a title="Dropbox" target="_blank" href="<?php echo esc_url( $dropbox ); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 28 28">
                        <path d="M6.3 11l7.7 4.8-5.3 4.5-7.7-5zM21.7 19.7v1.7l-7.7 4.6v0l0 0 0 0v0l-7.6-4.6v-1.7l2.3 1.5 5.3-4.4v0l0 0 0 0v0l5.4 4.4zM8.7 1.8l5.3 4.5-7.7 4.8-5.3-4.2zM21.7 11l5.3 4.2-7.6 5-5.4-4.5zM19.4 1.8l7.6 5-5.3 4.2-7.7-4.7z"/>
                    </svg>
                </a>
			<?php endif; ?>
			...
			<?php if ( ! empty( $flickr ) ): ?>
                <a title="Flickr" target="_blank" href="<?php echo esc_url( $flickr ); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 28">
                        <path d="M19.5 2c2.5 0 4.5 2 4.5 4.5v15c0 2.5-2 4.5-4.5 4.5h-15c-2.5 0-4.5-2-4.5-4.5v-15c0-2.5 2-4.5 4.5-4.5h15zM10.9 14c0-1.8-1.5-3.3-3.3-3.3s-3.3 1.5-3.3 3.3 1.5 3.3 3.3 3.3 3.3-1.5 3.3-3.3zM19.7 14c0-1.8-1.5-3.3-3.3-3.3s-3.3 1.5-3.3 3.3 1.5 3.3 3.3 3.3 3.3-1.5 3.3-3.3z"/>
                    </svg>
                </a>
			<?php endif; ?>
	...
	function form( $instance ) {
        ...
        <p>
            ...
            <input type="text" class="widefat" id="<?php echo $this->get_field_id( 'dribbble' ); ?>"
                   ...
                   value="<?php echo $instance['dribbble']; ?>"
                   placeholder="http://dribbble.com/username"/>
        </p>
        <!-- Show dropbox -->
        <p>
            <label for="<?php echo $this->get_field_id( 'dropbox' ); ?>"><?php _e( 'dropbox', 'smbuttons' ) ?></label><br>
            <input type="text" class="widefat" id="<?php echo $this->get_field_id( 'dropbox' ); ?>"
                   name="<?php echo $this->get_field_name( 'dropbox' ); ?>" value="<?php echo $instance['dropbox']; ?>"
                   placeholder=""/>
        </p>
        <!-- Show flickr -->
        <p>
        ...
        <!-- Show Icon Color: Checkbox -->
        <p>
            <input type="text" class="icon_hover_color" id="<?php echo $this->get_field_id( 'icon_hover_color' ); ?>"
